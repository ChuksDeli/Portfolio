...
export default function Hero() {
  ...
  <header
  id="hero"
  className="bg-[linear-gradient(rgba(115,115,115,0.2)_1px,transparent_1px),linear-gradient(90deg,rgba(115,115,115,0.2)_1px,transparent_1px)] bg-size-[48px_48px] relative overflow-hidden"
>
      <Navbar />
      ...
      <section className="flex items-center justify-center text-center lg:pt-20 pt-10 relative z-10">
        ...
        <div className="absolute top-70 lg:right-50 right-10 w-200 h-200 rounded-full bg-blue-50/8 blur-3xl pointer-events-none" />
      </section>
