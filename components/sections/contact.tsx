      ...
      <div className="max-w-400 mx-auto">
        ...
        >
          <motion.a
            ...
            className="group bg-black p-10 md:p-12 text-white hover:scale-103 transition-all duration-700 block"
          >
          ...
          <motion.a
            ...
            target="_blank"
            className="group bg-black p-10 md:p-12 hover:scale-103 transition-all duration-700 block"
          >
