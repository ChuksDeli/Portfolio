...
export default function Skills() {
  ...
  return (
    <motion.section
      ...
      className="text-white bg-[linear-gradient(rgba(115,115,115,0.2)_1px,transparent_1px),linear-gradient(90deg,rgba(115,115,115,0.2)_1px,transparent_1px)] bg-size-[48px_48px] lg:min-h-screen h-[90vh] flex flex-col justify-center"
    >
      <motion.p
        variants={item}
      ...
      >
        {skills.map((skill) => (
          <motion.div
            ...
            viewport={{ amount: 0.3 }}
            className="bg-black flex gap-3 justify-center items-center lg:px-17 lg:py-10 px-7 py-5 transition-colors duration-300"
          >
