...
export default function AboutPreview() {
  ...
  return (
    <motion.section
      ...
      className="max-w-5xl flex lg:flex-row lg:mx-auto flex-col lg:items-center px-4 lg:px-0 lg:justify-between gap-5 py-24 h-[70vh] lg:h-[90vh]"
    >
      <motion.div>
        <motion.h2
          variants={item}
          className="text-xl uppercase tracking-widest text-neutral-500 mb-4"
        >
          About Me
        </motion.h2>
      </motion.div>
