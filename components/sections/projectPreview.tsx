...
const featuredProjects: Project[] = [
  ...
  },
  {
    ...
    category: "FinTech",
    description:
      "BillSpiltSafe is a web application designed to help people manage shared expenses without confusion. it allows users to split bills, track who owes what, and view their personal expense history in a clear and simple dashboard, reducing payment disputes among friends, roommates, and shared households.",
