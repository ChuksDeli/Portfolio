...
export default function Hero() {
  ...
  return (
    <header id="hero" className="h-screen relative overflow-hidden">
      ...
      <section className="flex items-center lg:pt-20 pt-10 relative z-10">
        <motion.div
          variants={container}
          viewport={{ amount: 0.2 }}
          initial="hidden"
        ...
        <div className="absolute top-0 right-0 w-200 h-200 rounded-full bg-blue-50/8 blur-3xl pointer-events-none" />
      </section>
